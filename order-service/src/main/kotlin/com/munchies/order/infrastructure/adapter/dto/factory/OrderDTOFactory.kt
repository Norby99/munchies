...
sealed interface OrderDTOFactory {

  fun Order.fromDomain(): OrderDto

  fun OrderDto.fromDTO(): Order

  companion object {
    private class DefaultOrderDTOFactory : OrderDTOFactory {
      override fun Order.fromDomain(): OrderDto {
      ...
      override fun OrderDto.fromDTO(): Order {
    ...
    val default: OrderDTOFactory = DefaultOrderDTOFactory()
  }
}

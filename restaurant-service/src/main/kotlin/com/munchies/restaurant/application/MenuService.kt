...
import com.munchies.restaurant.application.usecase.menu.RemoveMenuCommand
...
import com.munchies.restaurant.application.usecase.menu.RemoveMenuResult
...
interface MenuService : CategoryService, MenuItemService {
  ...
  suspend fun removeMenu(command: RemoveMenuCommand): RemoveMenuResult
...
class MenuApplicationService(
  ...
  override suspend fun createMenu(command: CreateMenuCommand): CreateMenuResult = menuUseCases.add(
    command,
  )
  override suspend fun updateMenu(command: UpdateMenuCommand): UpdateMenuResult =
    menuUseCases.update(command)
  override suspend fun removeMenu(command: RemoveMenuCommand): RemoveMenuResult =
    menuUseCases.remove(command)
  override suspend fun getMenu(command: GetMenuCommand): GetMenuResult =
    menuUseCases.getDetails(command)

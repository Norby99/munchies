 ...
 * @property lockedUntil The timestamp (in milliseconds) until which the account is locked. Defaults to -1L, indicating no lock.
 * @property lastLogin The timestamp (in milliseconds) of the user's last successful login. Defaults to 0L.
 */
